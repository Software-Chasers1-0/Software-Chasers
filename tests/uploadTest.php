...
class uploadTest extends TestCase{
    ...
    mysqli_query($link,"CREATE TABLE books (book_id int,book_name varchar(255),book_author varchar(255),book_isbn int(11),book_price float(11),subcategory_id int,user_id int, book_image varchar(255))");
   ...
   */
    ...
    {
        $this->assertNotEmpty($this->DataHolder->sell('bookname','author','55.5','123456','Science','14','img'));
    }
