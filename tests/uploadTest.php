...
class uploadTest extends TestCase{
    ...
    public function test_if_Empty()
    {
        ...
        $this->assertTrue($this->DataHolder->sell('','author','55.5','123456','Science','BSC','14','img'),'invalid input');
        $this->assertTrue($this->DataHolder->sell('bookname','','55.5','123456','Science','BSC','14','img'),'invalid input');
        $this->assertTrue($this->DataHolder->sell('bookname','author','','123456','Science','BSC','14','img'),'invalid input');
        $this->assertTrue($this->DataHolder->sell('bookname','author','55.5','','Science','BSC','14','img'),'invalid input');
        $this->assertTrue($this->DataHolder->sell('bookname','author','55.5','123456','','BSC','14','img'),'invalid input');
        $this->assertTrue($this->DataHolder->sell('bookname','author','55.5','123456','Science','','','img'),'invalid input');
        $this->assertTrue($this->DataHolder->sell('bookname','author','55.5','123456','Science','BSC','14',''),'invalid input');
        $this->assertTrue($this->DataHolder->sell("","","","","","","",""),'invalid input');
    }
