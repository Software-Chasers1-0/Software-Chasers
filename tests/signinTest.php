...
class signinTest extends PHPUnit\Framework\TestCase{
	...
	public function setUp() : void {//this part of the code initiates the hello variable
		...
		mysqli_query($link,"CREATE TABLE users (user_id int NOT NULL AUTO_INCREMENT,user_name varchar(255),user_password varchar(255),user_email varchar(255),user_role varchar(255) NULL)");
		mysqli_query($link,"INSERT INTO users (user_name,user_password,user_role,user_email) values('pfariso','Pfariso.@1','null','mpfumbapfariso@gmail.com')");
	}
	/**
	 * @covers ::sign
	 */
